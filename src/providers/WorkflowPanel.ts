...
export class WorkflowPanel implements vscode.WebviewViewProvider {
    public static readonly viewId = 'fortressWorkflowPanel';
    ...
    private async _lookup(workflowId: string): Promise<void> {
        ...
        try {
            ...
            this._post({
                ...
                workflow: {
                    ...
                    test_code:
                        (result.artifacts?.['test_code'] as string | undefined) ??
                        (result.artifacts?.['generated_code'] as string | undefined) ??
                        '',
